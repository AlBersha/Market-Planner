...
import com.example.marketplanner.CompanyViewModel
...
class MarketplaceFragment : Fragment(), CompanyAdapter.OnItemClickListener {
...
//        binding.recyclerMarketplaceView.adapter = adapter
...
//        transaction?.replace(R.id.marketplaceContainer, CompanyDetailsFragment())
